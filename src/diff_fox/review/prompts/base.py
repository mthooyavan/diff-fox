...
AGENT_CONFIGS = {
    "logic": {
        ...
        "context_relevance_hints": [
            "optional", "none", "null", "error", "exception", "raise", "try",
            "return", "assert", "validate", "check", "parse", "convert",
        ],
    },
    "security": {
        "guideline_categories": ["security", "api"],
        "context_relevance_hints": [
            "auth", "login", "session", "token", "password", "secret", "key",
            "sanitize", "validate", "escape", "middleware", "handler", "route",
            "encrypt", "decrypt", "hash", "permission", "role", "acl",
        ],
    },
    "architecture": {
        "guideline_categories": ["architecture", "api", "lint"],
        "context_relevance_hints": [
            "interface", "abstract", "base", "factory", "service", "repository",
            "controller", "model", "schema", "config", "init", "setup",
        ],
    },
    "performance": {
        "guideline_categories": ["performance"],
        "context_relevance_hints": [
            "query", "database", "db", "cache", "redis", "loop", "iterate",
            "request", "response", "handler", "async", "await", "pool", "batch",
        ],
    },
    "risk": {
        "guideline_categories": ["security", "general"],
        "context_relevance_hints": [
            "migration", "deploy", "config", "flag", "rollback", "auth",
            "payment", "critical", "database", "schema", "version", "release",
        ],
    },
    "cogs": {
        "guideline_categories": ["performance", "general"],
        "context_relevance_hints": [
            "api", "http", "request", "query", "database", "llm", "openai",
            "anthropic", "s3", "redis", "cache", "lambda", "metric", "log",
        ],
    },
}
